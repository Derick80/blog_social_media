    ...
    return (
        <div key={ userProfile.id } className="">
            <div>
                ...
                <p className='italic text-sm'> { userProfile.title }</p>


                <div className='flex flex-row gap-5'>
                    <div className='w-1/2 h-1/2'>  <img src={ userProfile.profilePicture } alt="profile" /></div>
                    <div>
                        <div>About Me</div>
