  ...
  return (
    <>
      <div className='flex flex-col items-center'>
        ...
        <small className='text-sm italic'>              {data.post?.published ? "You are editing a published post" : "you are editing a draft post"}</small>
          ...
          <p>
            <label>
              <FormField
                ...
                aria-invalid={
                  Boolean(actionData?.fieldErrors?.body) || undefined
                }
                aria-errormessage={
